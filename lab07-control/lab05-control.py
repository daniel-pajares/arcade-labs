...
class Ball:
    ...
    def laser(self):
        # plays laser sound when the user bumps the edge of the screen,
        # we may want to play the bump sound once, and not 60 times per second
...
class MyGame(arcade.Window):
    ...
    def on_mouse_press(self, x, y, button, modifiers):
        ...
        if button == arcade.MOUSE_BUTTON_LEFT:
            ...
            # plays sound when left mouse button is pressed
